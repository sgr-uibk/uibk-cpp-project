...
{
	forEachTileInLayer<false>(m_state.getGroundLayer(), [&](sf::Vector2i tileSprite, sf::Vector2i mapTileDim,
	                                                        sf::Vector2i srcPixel, sf::Vector2i screenPos) {
		sf::Vector2f const spritePos{screenPos.x - tileSprite.x / 2.f, screenPos.y - tileSprite.y + mapTileDim.y / 2.f};
...
{
	forEachTileInLayer<true>(m_state.getWallsLayer(), [&](sf::Vector2i tileSprite, sf::Vector2i mapTileDim,
	                                                      sf::Vector2i srcPixel, sf::Vector2i screenPos) {
