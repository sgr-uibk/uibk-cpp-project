...
namespace GameConfig
{
	...
	namespace Menu
	{
		...
		inline sf::Color buttonColor() { return sf::Color(80, 80, 80); }
		inline sf::Color buttonHoverColor() { return sf::Color(100, 100, 100); }
		inline sf::Color buttonDisabledColor() { return sf::Color(50, 50, 50); }
		inline sf::Color inputBoxColor() { return sf::Color(40, 40, 40); }
		inline sf::Color outlineColor() { return sf::Color(100, 100, 100); }
		inline sf::Color outlineHoverColor() { return sf::Color(150, 150, 150); }
		inline sf::Color outlineActiveColor() { return sf::Color(200, 200, 100); }
	}
}